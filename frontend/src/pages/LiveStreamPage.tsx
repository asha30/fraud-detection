...
/* ── Alert panel item ─────────────────────────────────────────── */
function AlertItem({ tx, index }: { tx: LiveTransaction; index: number }) {
                    ...
                    {transactions.map((tx, i) => {
                      ...
                      return (
                        <tr
                          ...
                          className={[
                            'border-t border-slate-900/5 transition-colors',
                            isNew ? 'bg-sky-50/60' : isFraud ? 'bg-rose-50/50 hover:bg-rose-50' : 'hover:bg-slate-50/70',
                          ].join(' ')}
                        >
